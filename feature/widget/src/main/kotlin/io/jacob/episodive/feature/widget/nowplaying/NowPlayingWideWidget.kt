...
/**
 * 4x1 가로 바 NowPlaying 위젯. 데이터 구독 규약은 [NowPlayingWidget] 과 동일하며
 * 콘텐츠만 [NowPlayingWideContent] 를 쓴다.
 */
class NowPlayingWideWidget : GlanceAppWidget() {
    ...
    override suspend fun provideGlance(context: Context, id: GlanceId) {
        ...
        provideContent {
            ...
            EpisodiveGlanceTheme {
                NowPlayingWideContent(snapshot, bitmap, backgroundColor)
            }
        }
    }
}
