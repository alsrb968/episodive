...
**마지막 검증**: `b363b18` (2026-08-07) — 홈 섹션 더보기 추가에 맞춰 1.2 홈과 알려진 한계를 갱신했습니다.
...
| 홈 '더보기' 첫 진입 | 팟캐스트 섹션은 전체 목록용 캐시를 처음 채울 때 피드마다 상세 요청이 붙어 지연이 있음 (`PodcastRemoteUpdater.kt:55-66`) |
